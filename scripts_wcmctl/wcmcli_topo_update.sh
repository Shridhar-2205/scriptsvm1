...
kind load docker-image appn/connectivity-domain-operator:latest --name kind-1
kind load docker-image appn/wcmd:latest --name kind-1
cd ..
cd /home/ubuntu/go/src/github.com/cisco-app-networking/wcm-system/wcmctl 
./wcmctl install central-cluster-components --connectivitydomain-operator-appdns-org containers.cisco.com/appn --connectivitydomain-operator-nsr-org containers.cisco.com/appn --connectivitydomain-operator-org appn --connectivitydomain-operator-wcmd-org appn --connectivitydomain-operator-cdinfo-org containers.cisco.com/appn  --wait --kubeconfig /home/ubuntu/kubeconfigs/central/kind-1.kubeconfig
